...
with st.sidebar:
    ...
    if st.button("Request Form", key="request_form_btn", type="primary", use_container_width=True):
        st.session_state["current_page"] = "request_form"
        st.rerun()

if st.session_state["current_page"] == "dashboard":
    st.subheader("Excused Absence Dashboard")
    ...
    st.subheader("Excused Absence Request Form")
    ...
    if st.button("Submit Request", key="request_submit_button", type="primary", use_container_width=True):
